...
public class UserDAO {
	...
	private final String SIGN_IN = "insert into users (id, password, phone, email, addr)"
									+ "VALUES (?, ?, ?, ?, ?)";
	private final String ADMIN_SIGN_IN = "insert into users (id, password, phone, email, addr, role)"
			+ "VALUES (?, ?, ?, ?, ? ,?)";
	
	private final String USER_LIST = "select id,password,email,regdate from users order by id ASC";
